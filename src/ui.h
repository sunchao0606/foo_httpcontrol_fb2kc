...
// File reader buffer size
#define HTTPC_READ_FILE_BUFFER_SIZE 16385
...
namespace ui
{
	...
	namespace gen {
		...
		extern void helper(pfc::string_base &result);
		extern void helperx(pfc::string_base &result);
		...
		extern void discart(pfc::string_base& result);
		...
		extern void playlist_is_locked(pfc::string_base& result);
