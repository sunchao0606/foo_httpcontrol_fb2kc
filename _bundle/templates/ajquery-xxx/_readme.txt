...
*** Release history 2024
	11 Jun  0.98
		...
		cha:	Updated keyboard shortcuts processing to work with most new browsers and different
				keyboard layouts. Old method is still used as fallbak for legacy browsers.
		...
		cha:	Folders are now enclosed with [] on the file browser table, show 'Folder' as extension 
				and '-' as size.
		cha:	Common audio extensions, like 'MP3', are now displayed with the short name instead of using
				the long name (i.e. 'MPEG layer 3') on the file browser table.
